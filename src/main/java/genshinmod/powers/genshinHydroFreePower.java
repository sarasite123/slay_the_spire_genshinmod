...
public class genshinHydroFreePower extends AbstractPower {
    public static final String POWER_ID = ModHelper.makePath("HydroFreePower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    private static final String NAME = powerStrings.NAME;
    private static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    private final AbstractCreature player; // Add this line to store the player

    public genshinHydroFreePower(AbstractCreature m, AbstractCreature p) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = m;

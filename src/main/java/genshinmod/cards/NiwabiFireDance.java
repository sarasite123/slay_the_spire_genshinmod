...
public class NiwabiFireDance extends CustomCard {
        public static final String ID = ModHelper.makePath("NiwabiFireDance");
        private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
        private static final String NAME = CARD_STRINGS.NAME;
        private static final String IMG_PATH = "GenshinModResources/img/cards/skill/NiwabiFireDance.png";
        ...
        public void use(AbstractPlayer p, AbstractMonster m) {
            AbstractDungeon.actionManager.addToBottom(new SFXAction("genshin:NiwabiFireDance"));
    ...
    public void onRetained() {
            if(!upgraded){
                ...
                this.truebase = this.truebase+3;
            }
            else {
                this.upgradeMagicNumber(4);
                this.truebase = this.truebase+4;
            }
    }
}

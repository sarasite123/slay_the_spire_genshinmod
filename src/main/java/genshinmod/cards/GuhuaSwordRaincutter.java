...
public class GuhuaSwordRaincutter extends CustomCard {
    public static final String ID = ModHelper.makePath("GuhuaSwordRaincutter");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "GenshinModResources/img/cards/skill/GuhuaSwordRaincutter.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new SFXAction("genshin:GuhuaSwordRaincutter"));

...
public class UniversalityAnElaborationonForm extends CustomCard {
    public static final String ID = ModHelper.makePath("UniversalityAnElaborationonForm");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "GenshinModResources/img/cards/attack/UniversalityAnElaborationonForm.png";
    ...
    public UniversalityAnElaborationonForm() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractPower dentroPower = m.getPower(ModHelper.makePath("DentroPower"));
        if(dentroPower==null)
        {

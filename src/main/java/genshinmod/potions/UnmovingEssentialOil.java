...
public class UnmovingEssentialOil extends BasePotion {
    public static final String ID = ModHelper.makePath("UnmovingEssentialOil");
    ...
    private static final String IMG_PATH = "GenshinModResources/img/potions/64/UnmovingEssentialOil.png";
    ...
    public void use(AbstractCreature target) {
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            this.addToBot(new MakeTempCardInHandAction(new WildStar(), this.potency));
        }
    }
    ...
    public void addAdditionalTips() {
        ...
        String title = BaseMod.getKeywordTitle("genshin:结晶");
        String description = BaseMod.getKeywordDescription("genshin:结晶");
    ...
    public AbstractPotion makeCopy() { return new GushingEssentialOil(); }

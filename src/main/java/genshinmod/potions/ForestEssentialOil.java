...
public class ForestEssentialOil extends BasePotion {
    public static final String ID = ModHelper.makePath("ForestEssentialOil");
    ...
    private static final String IMG_PATH = "GenshinModResources/img/potions/64/ForestEssentialOil.png";
    ...
    public ForestEssentialOil() {
        super(ID, 2, PotionRarity.COMMON, BasePotion.customShape, LIQUID_COLOR, HYBRID_COLOR, SPOTS_COLOR);
    ...
    public void use(AbstractCreature target) {
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            this.addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new genshinElementalMasteryPower(AbstractDungeon.player, this.potency), this.potency));
        }
    }
    ...
    public void addAdditionalTips() {
        ...
        String title = BaseMod.getKeywordTitle("genshin:元素精通");
        String description = BaseMod.getKeywordDescription("genshin:元素精通");
    ...
    public AbstractPotion makeCopy() { return new ForestEssentialOil(); }

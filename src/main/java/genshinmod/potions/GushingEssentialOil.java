...
public class GushingEssentialOil extends BasePotion {
    public static final String ID = ModHelper.makePath("GushingEssentialOil");
    ...
    private static final String IMG_PATH = "GenshinModResources/img/potions/64/GushingEssentialOil.png";
    ...
    public void use(AbstractCreature target) {
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            this.addToBot(new MakeTempCardInHandAction(new AnemoSeed(), this.potency));
        }
    }
    ...
    public void addAdditionalTips() {
        ...
        String title = BaseMod.getKeywordTitle("genshin:扩散");
        String description = BaseMod.getKeywordDescription("genshin:扩散");
